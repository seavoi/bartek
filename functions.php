...
// Enqueue Scripts
if (!is_admin()) {
 wp_enqueue_script('bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array('jquery'), array(), date('mdygi'), $in_footer = true);
 wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', array('jquery'), array(), date('mdygi'), $in_footer = true);
}
